    ...
    <div className="min-h-screen bg-cr-ivory font-body">
      ...
      <section className="bg-cr-ivory py-24 px-4">
        <div className="max-w-4xl mx-auto text-center">
          <span className="inline-block px-3 py-1 rounded-full text-sm font-body bg-cr-gold/10 text-cr-gold border border-cr-gold/20 mb-6">Supported Living</span>
          <h1 className="font-display text-5xl md:text-6xl font-semibold text-cr-charcoal mb-5 leading-tight">Person-centred care. Properly documented.</h1>
